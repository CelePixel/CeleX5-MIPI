		...
		if (!m_bLoopModeEnabled)
		{
			...
			else if (EventShowByTime == m_emEventShowType) //show by time
			{
				if (m_uiEventTCounter > m_uiEventTCountForShow)
				{
					...
					{
						m_lEventFrameTimeStamp = m_lLastPackageTimeStamp + m_uiPackageTCounter / 50; //m_uiPackageTCounter * 20 / 1000
					}
...
void CeleX5DataProcessor::parseEventData(uint8_t* pData, int dataSize, std::time_t time_stamp)
{
